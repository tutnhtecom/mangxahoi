        ...
        <div class="modal-body twocheckout_modal">
          ...
          <div class="col-lg-12">
          	<div class="wow_form_fields">
	            ...
	            <input name="name" type="text" autocomplete="off" value="<?php echo $wo['project']->name ?>">
	          </div>
          </div>
          <div class="col-lg-6">
          	<div class="wow_form_fields">
	            <label><?php echo $wo['lang']['start_date']; ?></label>
	            <input type="text" class="edit_project_start_<?php echo $wo['project']->id ?>" name="project_start" value="<?php echo $wo['project']->project_start ?>">
	          </div>
          </div>
          <div class="col-lg-6">
          	<div class="wow_form_fields">
	            <label><?php echo $wo['lang']['end_date']; ?>:</label>  
	            <input type="text" class="edit_project_end_<?php echo $wo['project']->id ?>" name="project_end" value="<?php echo $wo['project']->project_end ?>">
	          </div>
          </div>
          <div class="col-lg-6">
          	<div class="wow_form_fields">
	          	<label class="plr15"><?php echo $wo['lang']['associated_with']; ?></label> 
	            <input name="associated_with" type="text" autocomplete="off" value="<?php echo $wo['project']->associated_with ?>">
	          </div>
          </div>
          <div class="col-lg-6">
          	<div class="wow_form_fields">
	          	<label><?php echo $wo['lang']['project_url']; ?></label> 
	            <input name="project_url" type="text" autocomplete="off" value="<?php echo $wo['project']->project_url ?>">
	          </div>
          </div>
          <div class="col-lg-12">
          	<div class="wow_form_fields">
	          	<label><?php echo $wo['lang']['description']; ?></label>
	            <textarea name="description" rows="5"><?php echo $wo['project']->description ?></textarea>
	          </div>
          </div>
		  </div>
          <div class="clear"></div>
