	...
	<div class="modal-dialog wow_mat_mdl modal-md">
		<div class="modal-content text-center wo_calling_modals video">
			...
			<div class="modal-footer">
				<button data-href="<?php echo $wo['incall']['url'];?>" type="button" class="btn answer-call btn-main btn-mat" onclick="Wo_AnswerCall('<?php echo $wo['incall']['id'];?>', '<?php echo $wo['incall']['url'];?>');"><i class="fa fa-video-camera progress-icon" data-icon="video-camera"></i> <?php echo $wo['lang']['accept_and_start'];?></button>
				<button type="button" class="btn decline-call btn-default btn-mat" onclick="Wo_DeclineCall('<?php echo $wo['incall']['id'];?>');"><i class="fa fa-times progress-icon" data-icon="times"></i> <?php echo $wo['lang']['decline'];?></button>
			</div>
		</div>
	</div>
</div>